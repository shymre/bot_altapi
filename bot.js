...
client.on('message', msg => {
    ...
    if (msg.content === 'selamýn aleyküm') {
    ...
    if (msg.content === 'günaydýn') {
        msg.reply('sana da günaydýn');
    }

    if (msg.content === 'herkese günaydýn') {
    ...
    if (msg.content === 'iyi akþamlar') {
        msg.reply('sana da iyi akþamlar');
    }
